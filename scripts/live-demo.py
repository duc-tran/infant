    ...
    while True:
        ...
        if save_video:
            if video_writer is None:
                ...
                video_writer = cv2.VideoWriter('avi.avi', fourcc, video_framerate, (frame.shape[1], frame.shape[0]))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_video", help="save avi frames into a video.", action="store_true")
